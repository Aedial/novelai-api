...
class Low_Level:
	...
	async def request(self, request_method: MethodDescriptorType, endpoint: str, data: Optional[Union[Dict[str, Any], str]]) -> Union[Tuple[ClientResponse, Any], NovelAIError]:
		"""
	...
	async def get(self, endpoint: str) -> Union[Tuple[ClientResponse, Any], NovelAIError]:
		return await self.request(self._session.get, endpoint, None)

	async def post(self, endpoint: str, data: Dict[str, Any]) -> Union[Tuple[ClientResponse, Any], NovelAIError]:
		return await self.request(self._session.post, endpoint, data)

	async def put(self, endpoint: str, data: Union[Dict[str, Any], str],need_login: bool = True) -> Union[Tuple[ClientResponse, Any], NovelAIError]:
		return await self.request(self._session.put, endpoint, data)

	async def patch(self, endpoint: str, data: Dict[str, Any]) -> Union[Tuple[ClientResponse, Any], NovelAIError]:
		return await self.request(self._session.patch, endpoint, data)

	async def delete(self, endpoint: str) -> Union[Tuple[ClientResponse, Any], NovelAIError]:
